...
extern void global_inirtn(intptr_t exinf);
extern void global_terrtn(intptr_t exinf);
extern void local_inirtn(intptr_t exinf);
extern void local_terrtn(intptr_t exinf);
