 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: allfunc.h 438 2009-10-14 16:04:47Z ertl-honda $
 */
...
/* mp.c */
#define TOPPERS_mpini
#define TOPPERS_ipi_handler
#define TOPPERS_disp_req
#define TOPPERS_ext_ker_req
...
#define TOPPERS_tsklowprce
#define TOPPERS_tsktex
#define TOPPERS_migrate_self
#define TOPPERS_exit_and_migrate_self
...
#define TOPPERS_get_my_current_time

/* task_manage.c */
#define TOPPERS_mig_tsk
#define TOPPERS_act_tsk
#define TOPPERS_iact_tsk
#define TOPPERS_mact_tsk
#define TOPPERS_imact_tsk
...
/* spin_lock.c */
#define TOPPERS_spnini
#define TOPPERS_force_unlock_spin
#define TOPPERS_loc_spn
#define TOPPERS_iloc_spn
#define TOPPERS_unl_spn
#define TOPPERS_iunl_spn
#define TOPPERS_try_spn
#define TOPPERS_itry_spn
#define TOPPERS_ref_spn

/* sys_manage.c */
#define TOPPERS_rot_rdq
#define TOPPERS_irot_rdq
#define TOPPERS_mrot_rdq
#define TOPPERS_imrot_rdq
#define TOPPERS_get_tid
#define TOPPERS_iget_tid
#define TOPPERS_get_pid
#define TOPPERS_iget_pid
