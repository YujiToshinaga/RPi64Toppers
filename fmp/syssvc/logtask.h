 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: logtask.h 567 2010-04-14 08:46:20Z ertl-honda $
 */
...
#ifndef LOGTASK_PORTID_PRC1
#define LOGTASK_PORTID_PRC1		1	/* システムログ用のシリアルポート番号 */
#endif /* LOGTASK_PORTID_PRC1 */

#ifndef LOGTASK_PORTID_PRC2
#define LOGTASK_PORTID_PRC2		2	/* システムログ用のシリアルポート番号 */
#endif /* LOGTASK_PORTID_PRC2 */

#ifndef LOGTASK_PORTID_PRC3
#define LOGTASK_PORTID_PRC3		3	/* システムログ用のシリアルポート番号 */
#endif /* LOGTASK_PORTID_PRC3 */

#ifndef LOGTASK_PORTID_PRC4
#define LOGTASK_PORTID_PRC4		4	/* システムログ用のシリアルポート番号 */
#endif /* LOGTASK_PORTID_PRC4 */

#ifndef LOGTASK_PORTID_G_SYSLOG
#define LOGTASK_PORTID_G_SYSLOG		1	/* システムログ用のシリアルポート番号 */
#endif /* LOGTASK_PORTID_G_SYSLOG */
