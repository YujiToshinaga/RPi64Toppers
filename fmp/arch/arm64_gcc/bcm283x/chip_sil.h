...
//
//#define SIL_GICC_PMR  (SIL_GICC_BASE + 0x04)  /* 優先度マスクレジスタ */
//
//#if SIL_GIC_PRI_LEVEL == 32
//#define SIL_GICC_PMR_OFFSET 0x03
//#elif SIL_GIC_PRI_LEVEL == 64
//#define SIL_GICC_PMR_OFFSET 0x02
//#elif SIL_GIC_PRI_LEVEL == 128
//#define SIL_GICC_PMR_OFFSET 0x01
//#elif SIL_GIC_PRI_LEVEL == 256
//#define SIL_GICC_PMR_OFFSET 0x00
//#else
//#error
//#endif /* SIL_GIC_PRI_LEVEL == 32 */
//
//Inline void
//TOPPERS_set_iipm(uint8_t iipm)
//{
//	*((volatile uint32_t *)SIL_GICC_PMR) = iipm << SIL_GICC_PMR_OFFSET;
//}
//
//Inline uint8_t
//TOPPERS_get_iipm(void)
//{
//	return ((uint8_t)(*((volatile uint32_t *)SIL_GICC_PMR) >> SIL_GICC_PMR_OFFSET));
//}
//
///*
// *  すべての割込みの禁止
