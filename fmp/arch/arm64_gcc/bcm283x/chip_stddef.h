 ...
 *  の責任を負わない．
 *
 *  @(#) $Id: chip_stddef.h 1149 2016-01-08 08:19:14Z ertl-toshinaga $
 */

/*
 *  t_stddef.hのチップ依存部（BCM283X用）
 *
 ...
 *  ターゲットを識別するためのマクロの定義
 */
#define TOPPERS_BCM283X                /* システム略称 */

/*
 *  ARM64で共通な定義
 */
#include "arm64_gcc/common/core_stddef.h"
