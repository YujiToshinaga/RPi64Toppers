...
/*
 *  プロセッサ依存プロセッサコントロールブロックモジュール（RPI-ARM64用）
 */
 ...
 *  ロックの方式
 */
#define TTYPE_KLOCK P_KLOCK /* Processor lock method */
//#define TTYPE_KLOCK G_KLOCK /* Giant lock method */
//#define TTYPE_KLOCK F_KLOCK /* Fine-grained lock method */
 ...
 *  チップ依存モジュール（BCM283X用）
 */
#include "arm64_gcc/bcm283x/chip_pcb.h"
